...
@section('admin')
    ...
    <form method="post" action="{{ route('jurusan.store') }}" enctype="multipart/form-data" id="myForm">
        @csrf
        ...
        <div class="mt-4">
            ...
            <div class="input-group mt-1">
                ...
                <input class="intro-x login__input form-control py-3 px-4 block" type="text"
                    placeholder="Masukkan Kode Jurusan" name="kode_jurusan" id="kode_jurusan" required>
            </div>
