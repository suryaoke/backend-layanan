<table id="datatable" class="table table-bordered">
    <thead>
        <tr>
            ...
            <th style="width:100px; border: 2px solid black; text-align: center; background-color: yellow;">Kode Catatan
            </th>
            ...
            <th style="width:100px; border: 2px solid black; text-align: center; background-color: yellow;">Catatan</th>
        </tr>
    </thead>
    <tbody>
