                                    ...
                                    @foreach ($jadwalByDay as $index => $jadwal)
                                        ...
                                        @if (!in_array($timeSlot, $printedTimeSlots))
                                            <tr>
                                                @if ($index === 0)
                                                    <td
                                                        rowspan="{{ $harijumlah }} "style="background-color: rgb(187,191,195)">
                                                        {{ $haridata->nama }}
                                                    </td>
                                                @endif
...
<div id="pdf-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('jadwalortu.pdf') }}">
                @csrf
                ...
                <div class="modal-footer">
                    <a href="{{ route('jadwalmapel.ortu') }}" class="btn btn-outline-secondary w-20 mr-1">Cancel</a>
