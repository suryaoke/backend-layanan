 <table id="datatable" class="table table-bordered">
     <thead>
         <tr>
             <th colspan="11" style="border: 2px solid black; text-align: center; font-weight: bold;">
                 Data Nilai Sikap Sosial Siswa</th>
         </tr>
         <tr>
             <th colspan="11" style="border: 2px solid black; text-align: center; font-weight: bold;">Semester
