                ...
                <div class="col-12">
                    <ul class="nav nav-boxed-tabs" role="tablist">
                        ...
                        <li id="example-5-tab" class="nav-item flex-1" role="presentation"> <button
                                ...
                                NILAI KETERAMPILAN UNJUK KERJA </button> </li>
        ...
        <div class="modal-dialog" style="max-width: 90vw; width: 55%;"> <!-- Menambahkan style langsung di sini -->
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Nilai Keterampilan Unjuk Kerja</h2>
                </div>
                <!-- END: Modal Header -->
                <!-- BEGIN: Modal Body -->
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3"
                    ...
                    <form method="post" action="{{ route('nilai.keterampilan.unjukkerja.store') }}"
                ...
                <div class="modal-footer">
                    <a href="{{ route('nilai.keterampilan.unjukkerja', $dataseksi->id) }}" type="button"
            ...
            <div class="modal-dialog" style="max-width: 90vw; width: 55%;">
                <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3"
                        style="overflow-x: auto; overflow-y: auto; max-height: 80vh;">
                        <!-- Menambahkan gaya overflow di sini -->
                        <form method="post" action="{{ route('nilai.keterampilan.unjukkerja.update') }}"
                            enctype="multipart/form-data" id="myForm">
                            @csrf
                            @php
    ...
    <div id="excel-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Export Nilai Keterampilan Unjuk Kerja</h2>
                ...
                <form method="post" action="{{ route('keterampilan.unjukkerja.excel') }}">
                    @csrf
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
