...
@section('admin')
                ...
                <div class="col-12">
                    <ul class="nav nav-boxed-tabs" role="tablist">
                        ...
                        <li id="example-5-tab" class="nav-item flex-1" role="presentation"> <button
                                ...
                                NILAI KETERAMPILAN PORTOFOLIO </button> </li>
                                    ...
                                    @if ($status == null || $status->status == '0')
                                        <div class="flex">
                                            <div class="mr-2">
                                                ...
                                                <a id="delete"
                                                    href="{{ route('nilai.keterampilan.portofolio.delete', ['id' => $kdItem->kd, 'id_seksi' => $dataseksi->id]) }}">
        ...
        <div class="modal-dialog" style="max-width: 90vw; width: 55%;"> <!-- Menambahkan style langsung di sini -->
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Nilai Keterampilan Portofolio</h2>
                </div>
                <!-- END: Modal Header -->
                <!-- BEGIN: Modal Body -->
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3"
                    ...
                    <form method="post" action="{{ route('nilai.keterampilan.portofolio.store') }}"
                        ...
                        <div class="mb-2">
                            <textarea name="catatan_keterampilan" id="" style="width: 350px;" rows="4" class="form-control "
                                required></textarea>
                ...
                <div class="modal-footer">
                    <a href="{{ route('nilai.keterampilan.portofolio', $dataseksi->id) }}" type="button"
            ...
            <div class="modal-dialog" style="max-width: 90vw; width: 55%;">
                <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3"
                        style="overflow-x: auto; overflow-y: auto; max-height: 80vh;">
                        <!-- Menambahkan gaya overflow di sini -->
                        <form method="post" action="{{ route('nilai.keterampilan.portofolio.update') }}"
                            enctype="multipart/form-data" id="myForm">
                            @csrf
                            @php
    ...
    <div id="excel-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Export Nilai Keterampilan Portofolio</h2>
                ...
                <form method="post" action="{{ route('keterampilan.portofolio.excel') }}">
                    @csrf
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
    ...
    <!-- Upload Nilia Portofolio --> <!-- BEGIN: Modal Content -->
    <div id="header1-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content"> <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Upload Data Nilai Portofolio</h2>

                    <form method="post" action="{{ route('nilai.portofolio.template') }}">
                        @csrf
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        <form
                            ...
                            class="dropzone flex justify-center items-center" action="{{ route('portofolio.upload') }}"
                ...
                <div class="modal-footer"> <a href="{{ route('nilai.keterampilan.portofolio', $dataseksi->id) }}"
