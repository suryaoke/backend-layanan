...
@section('admin')
                ...
                <div class="col-12">
                    <ul class="nav nav-boxed-tabs" role="tablist">
                        ...
                        <li id="example-5-tab" class="nav-item flex-1" role="presentation"> <button
                                ...
                                NILAI PENGETAHUAN HARIAN </button> </li>
                                    ...
                                    @if ($status == null || $status->status == '0')
                                        <div class="flex">
                                            <div class="mr-2">
                                                ...
                                                <a id="delete"
                                                    href="{{ route('nilai.pengetahuan.harian.delete', ['id' => $phItem->ph, 'id_seksi' => $dataseksi->id]) }}">
                                            ...
                                            <div>
                                                <a data-tw-toggle="modal"
                                                    data-tw-target="#edit-footer-modal-preview-{{ $phItem->ph }}">
        ...
        <div class="modal-dialog" style="max-width: 90vw; width: 55%;"> <!-- Menambahkan style langsung di sini -->
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Nilai Pengetahuan Harian</h2>
                </div>
                <!-- END: Modal Header -->
                <!-- BEGIN: Modal Body -->
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3"
                    ...
                    <form method="post" action="{{ route('nilai.pengetahuan.harian.store') }}"
                        enctype="multipart/form-data" id="myForm">
                        @csrf
                        <div class="mb-2 grid grid-cols-12">
                            <input type="hidden" name="id_seksi" value="{{ $dataseksi->id }}" id="">

                            PH: <input style="width: 60px;" type="number" name="ph" class="form-control ml-8"
                                required>
                        </div>

                        <div class="mb-1">Materi: </div>
                        <div class="mb-2">
                            <textarea name="catatan_pengetahuan" id="" style="width: 350px;" rows="4" class="form-control "
                                required></textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap; text-transform: capitalize;">
                                            <input class="phInputField" style="width: 70px;" type="number"
                                                name="nilai_pengetahuan[]" value="0">
                                        </td>
                ...
                <div class="modal-footer">
                    <a href="{{ route('nilai.pengetahuan.harian', $dataseksi->id) }}" type="button"
    ...
    @foreach ($phValues as $phItem)
        <div id="edit-footer-modal-preview-{{ $phItem->ph }}" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" style="max-width: 90vw; width: 55%;">
                <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3"
                        style="overflow-x: auto; overflow-y: auto; max-height: 80vh;">
                        <!-- Menambahkan gaya overflow di sini -->
                        <form method="post" action="{{ route('nilai.pengetahuan.harian.update') }}"
                            enctype="multipart/form-data" id="myForm">
                            @csrf
                            @php
                            ...
                            <div class="mb-2 grid grid-cols-12">
                                ...
                                PH: <input style="width: 60px;" type="number" name="ph"
                                    value="{{ $phItem->ph }}" class="form-control ml-8" readonly>
                            </div>

                            <div class="mb-1">Materi: </div>
                            <div class="mb-2">
                                <textarea name="catatan_pengetahuan" id="" style="width: 350px;" rows="4" class="form-control "> {{ $datanilai->catatan_pengetahuan }} </textarea>
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap; text-transform: capitalize;">
                                                ...
                                                <input class="editphInputField" style="width: 70px;" type="number"
                                                    ...
                                                    value="{{ $nilai->nilai_pengetahuan ?? '0' }}">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <div id="excel-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Export Nilai Pengetahuan Harian</h2>
                ...
                <form method="post" action="{{ route('pengetahuan.harian.excel') }}">
                    @csrf
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
    ...
    <!-- Upload Nilia Harian --> <!-- BEGIN: Modal Content -->
    <div id="header1-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content"> <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Upload Data Nilai Harian</h2>

                    <form method="post" action="{{ route('nilai.harian.template') }}">
                        @csrf
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        <form
                            ...
                            class="dropzone flex justify-center items-center" action="{{ route('harian.upload') }}"
                ...
                <div class="modal-footer"> <a href="{{ route('nilai.pengetahuan.harian', $dataseksi->id) }}"
